...
/***/ "./src/js/participation/UI.js":
/*!************************************!*\
  !*** ./src/js/participation/UI.js ***!
  \************************************/
/*! exports provided: participationUI */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "participationUI", function() { return participationUI; });
...
var participationUI = function () {
  ...
  var shiftStudentsArray = function shiftStudentsArray(array) {
    console.log("shift array");
    array.push(array.shift());
  };

  var unShiftStudentsArray = function unShiftStudentsArray(array) {
    console.log("unShift array");
    array.unshift(array.pop()); // array.push(studentsArray.pop());
  ...
  return {
    ...
    deleteStudent: function deleteStudent(e) {
      ...
      if (e.target.classList.contains('deleteStudent')) {
        ...
        studentsArray = _commonFunctions_js__WEBPACK_IMPORTED_MODULE_2__["commonFunctions"].removeStudentfromArray(studentsArray, e.target.id);
    ...
    goToPrevious: function goToPrevious(e) {
...
/***/ "./src/js/participation/controller.js":
/*!********************************************!*\
  !*** ./src/js/participation/controller.js ***!
  \********************************************/
/*! no exports provided */
...
/* harmony import */ var _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @babel/runtime/helpers/asyncToGenerator */ "./node_modules/@babel/runtime/helpers/asyncToGenerator.js");
/* harmony import */ var _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _UI_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./UI.js */ "./src/js/participation/UI.js");
...
}(_UI_js__WEBPACK_IMPORTED_MODULE_2__["participationUI"]);
