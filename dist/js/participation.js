  ...
  return {
    ...
    goToNext: function (e) {
      if (e.target.classList.contains('next')) {
        ...
        shiftStudentsArray(studentsArray); // console.log('teamArray-post-shift', teamsArray);
    ...
    goToPrevious: function (e) {
      if (e.target.classList.contains('previous')) {
        ...
        unShiftStudentsArray(studentsArray); // console.log('teamArray-post-shift', teamsArray);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _UI_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./UI.js */ "./src/js/participation/UI.js");
...
}(_UI_js__WEBPACK_IMPORTED_MODULE_0__["participationUI"]);
