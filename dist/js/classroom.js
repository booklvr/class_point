...
var classroomUI = (function () {
  ...
  var DOM = {
    ...
    radios: document
      .querySelector(DOMStrings.addStudentForm)
      .querySelectorAll(DOMStrings.genderRadio),
  ...
  const radioIsChecked = function (radioNodeList) {
    ...
    return [].some.call(
      radioNodeList,
      (radioNode) => radioNode.checked === true
    );
  };
  ...
  return {
    ...
    checkTeamSize: function (e) {
      ...
      if (e.target.dataset.class_size < 2) {
        ...
        addErrorMessage(
          "Sorry, you need to add some students before you can play a game."
        );
      }
    },
    updateStudent: function (e) {
      ...
      if (e.target.classList.contains("updateStudent")) {
        ...
        const formTarget = e.target.parentElement.parentElement.parentElement.parentElement.querySelector(
          ".update__form"
        );
