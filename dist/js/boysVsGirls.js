...
var boysVsGirlsUI = function () {
  ...
  let studentsArray = [];
  let teamsArray = [];
  let backupArray = []; //HELPER FUNCTIONS
  ...
  return {
    ...
    getClassroomData: async function () {
      ...
      studentsArray = _commonFunctions_js__WEBPACK_IMPORTED_MODULE_0__["commonFunctions"].shuffleArray(studentsArray);
    ...
    deleteStudent: function (e) {
      if (e.target.classList.contains('deleteStudent')) {
        _commonFunctions_js__WEBPACK_IMPORTED_MODULE_0__["commonFunctions"].removeStudentFromTeam(teamsArray, e.target.id);
        studentsArray = _commonFunctions_js__WEBPACK_IMPORTED_MODULE_0__["commonFunctions"].removeStudentfromArray(studentsArray, e.target.id); //remove the student form the DOM
    ...
    startGame: function (e) {
      ...
      _commonFunctions_js__WEBPACK_IMPORTED_MODULE_0__["commonFunctions"].startGame();
    ...
    changePointStudent: function (e) {
      ...
      if (target.classList.contains('add__student') || target.classList.contains('minus__student')) {
        ...
        _commonFunctions_js__WEBPACK_IMPORTED_MODULE_0__["commonFunctions"].updatePointsArrayAll(teamsArray, student, action);
    ...
    changeTeamPoints: function (e) {
      ...
      if (pointDiv.classList.contains('teamPoint')) {
        ...
        let action = _commonFunctions_js__WEBPACK_IMPORTED_MODULE_0__["commonFunctions"].plusOrMinus(target); // change points in teamsArray

        _commonFunctions_js__WEBPACK_IMPORTED_MODULE_0__["commonFunctions"].updatePointsArrayTeam(teamsArray, team.id, action); //update DOM 
    ...
    goToPrevious: function () {
      ...
      _commonFunctions_js__WEBPACK_IMPORTED_MODULE_0__["commonFunctions"].unShiftTeamsAndStudentArray(teamsArray); // console.log('teamArray-post-shift', teamsArray);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _UI_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./UI.js */ "./src/js/boysVsGirls/UI.js");
...
}(_UI_js__WEBPACK_IMPORTED_MODULE_0__["boysVsGirlsUI"]);
