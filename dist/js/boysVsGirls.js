    ...
    return {
        ...
        changeTeamPoints: function(e) {
            ...
            if (pointDiv.classList.contains('teamPoint')) {
                ...
                let action = _commonFunctions_js__WEBPACK_IMPORTED_MODULE_0__["commonFunctions"].plusOrMinus(target);

               

                // change points in teamsArray
                _commonFunctions_js__WEBPACK_IMPORTED_MODULE_0__["commonFunctions"].updatePointsArrayTeam(teamsArray, team.id, action)
        ...
        goToPrevious: function() {
            ...
            // shift arrays 
            _commonFunctions_js__WEBPACK_IMPORTED_MODULE_0__["commonFunctions"].unShiftTeamsAndStudentArray(teamsArray);
